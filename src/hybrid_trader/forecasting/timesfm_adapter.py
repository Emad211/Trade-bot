"""Optional TimesFM 2.5 adapter.

TimesFM is deliberately a challenger model. This adapter does not make trading
choices; it only returns point and quantile forecasts for a supplied series.
"""
...
class TimesFMForecaster:
    ...
    def _load(self) -> Any:
        ...
        model = timesfm.TimesFM_2p5_200M_torch.from_pretrained(self.settings.model_id)
        model.compile(
